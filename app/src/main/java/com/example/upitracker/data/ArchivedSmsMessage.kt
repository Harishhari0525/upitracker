...
@Entity(tableName = "archived_sms_messages",
    indices = [Index(name = "index_archived_sms_messages_on_content", value = ["originalSender", "originalBody", "originalTimestamp"], unique = true)]
)
data class ArchivedSmsMessage(
    ...
    @ColumnInfo(defaultValue = "'PARSED'") val parseStatus: String = "PARSED"
)
